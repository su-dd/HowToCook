...
ProjectPath = 'd:/workspace/HowToCook'
RecipesPath = ProjectPath + '/recipes'
DishesPath = ProjectPath + '/dishes'
TipsPath = ProjectPath + '/tips'
...
if __name__ == '__main__':
    ...
    # 刷新UUid
    UUID_MAPPING = uuid_create.generate_uuid_for_md_files([DishesPath, TipsPath], RecipesUuidFile)
    ...
    print("开始解析菜谱文件...")
    recipes_by_category = parse_dishes.scan_dishes_directory(DishesPath, UUID_MAPPING)
